...
byte* f1(byte *state, byte *key) {
    static byte output[16];
...
int main(int argc,char *argv[]){
    ...
    gettimeofday(&fin, 0);
    secondes = fin.tv_sec - debut.tv_sec;
    microsecondes = fin.tv_usec - debut.tv_usec;
    temps = secondes + microsecondes*1e-6;
