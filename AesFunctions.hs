...
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 0 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn (output) (a:b:c:d:e:f:reste) 0) (1)
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 1 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn (output) (g:h:i:j:k:l:reste) 1) (2)
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 2 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn (output) (m:n:o:p:q:r:reste) 2) (3)
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 3 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn (output) (s:t:u:v:w:x:reste) 3) (4)


transpose_aux_8 :: [Z_sur_256Z] -> [Z_sur_256Z] -> Int -> [Z_sur_256Z]
transpose_aux_8 _ output 4 = output
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 0 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn (output) (a:b:c:d:e:f:g:h:reste) 0) (1)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 1 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn (output) (i:j:k:l:m:n:o:p:reste) 1) (2)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 2 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn (output) (q:r:s:t:u:v:w:x:reste) 2) (3)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 3 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn (output) (y:z:aa:ab:ac:ad:ae:af:reste) 3) (4)
