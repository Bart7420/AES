...
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 0 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn_trans (output) (a:g:m:s:reste) 0) (1)
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 1 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn_trans (output) (b:h:n:t:reste) 1) (2)
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 2 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn_trans (output) (c:i:o:u:reste) 2) (3)
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 3 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn_trans (output) (d:j:p:v:reste) 3) (4)
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 4 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn_trans (output) (e:k:q:w:reste) 4) (5)
transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) output 5 = transpose_aux_6 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:reste) (putColumn_trans (output) (f:l:r:x:reste) 5) (6)


transpose_aux_8 :: [Z_sur_256Z] -> [Z_sur_256Z] -> Int -> [Z_sur_256Z]
transpose_aux_8 _ output 8 = output
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 0 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn_trans (output) (a:i:q:y:reste) 0) (1)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 1 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn_trans (output) (b:j:r:z:reste) 1) (2)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 2 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn_trans (output) (c:k:s:aa:reste) 2) (3)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 3 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn_trans (output) (d:l:t:ab:reste) 3) (4)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 4 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn_trans (output) (e:m:u:ac:reste) 4) (5)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 5 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn_trans (output) (f:n:v:ad:reste) 5) (6)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 6 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn_trans (output) (g:o:w:ae:reste) 6) (7)
transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) output 7 = transpose_aux_8 (a:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:v:w:x:y:z:aa:ab:ac:ad:ae:af:reste) (putColumn_trans (output) (h:p:x:af:reste) 7) (8)
...
-- binToHex (transpose (cipher (transpose (hexToBin "00 11 22 33 44 55 66 77 88 99 AA BB CC DD EE FF") 4) ( (transpose (hexToBin "00 01 02 03 04 05 06 07 08 09 0A 0B 0C 0D 0E 0F 10 11 12 13 14 15 16 17") 6))) 4) 30
